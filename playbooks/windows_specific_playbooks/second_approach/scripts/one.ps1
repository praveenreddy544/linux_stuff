...
Write-Host "`"$shortname`""-nonewline ',';Write-Host "`"Redmane`"" -nonewline ',';Write-Host "`"$cpuinfo`"" -nonewline ',';Write-Host "`"$ram_in_gb`"" -nonewline ',';Write-Host "`"Server FQDN is ---> $hname`"" -nonewline ',';Write-Host "`"`"" -nonewline ',';Write-Host "`"Windows`"" -nonewline ',';Write-Host "`"$os_version`"" -nonewline ',';Write-Host "`"high`"" -nonewline ',';Write-Host "`"production`"" -nonewline ',';Write-Host "`"$ip`""
